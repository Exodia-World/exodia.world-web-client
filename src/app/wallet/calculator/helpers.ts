...
export const STAKING_STARTDATE = moment('2018-7-30');
export const FIRST_INTEREST_PERIOD_END_DATE = moment('2018-7-30').add(3, 'years');
...
export const AFTER_STAKING_STARTDATE_FIRST_INTEREST_PERIOD_BETWEN_DATE = '2017-12-12';
